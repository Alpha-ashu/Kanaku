...
export const KaiAnswerCard: React.FC<Props> = ({ action, currency, showPrompt = true }) => {
  ...
  return (
    <div className="space-y-2.5" data-testid="kai-answer-card">
      {showPrompt && (
        <div className="flex justify-end">
          <p className="max-w-[85%] rounded-[22px] rounded-br-md bg-[#18181B] px-4 py-3 text-sm font-medium leading-snug text-white">
            {action.rawSegment}
          </p>
        </div>
      )}
