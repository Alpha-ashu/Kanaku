...
export const ClientManagementPage: React.FC = () => {
 ...
 <span className="text-2xs font-black uppercase text-teal-200 tracking-wider block">Assets Under Management</span>
 ...
 <span className="px-2 py-0.5 rounded-full text-2xs font-black uppercase bg-amber-50 border border-amber-200 text-amber-600 tracking-wider">Pending Approval</span>
 )}
 </h4>
 <span className="text-2xs text-slate-400 font-bold uppercase tracking-widest mt-1 block">Joined: {client.joinedDate}</span>
 </div>
 <span className={`px-2.5 py-1 rounded-full text-2xs font-black uppercase tracking-widest ${
 ...
 <div>
 <span className="text-2xs font-black text-slate-400 uppercase tracking-widest block">Portfolio Valuation</span>
 ...
 className="bg-teal-600 text-white px-4 py-2.5 rounded-xl text-2xs font-black uppercase tracking-widest hover:bg-teal-700 active:scale-95 transition-all shadow-sm flex items-center gap-1"
 >
 ...
 className="bg-slate-50 text-slate-600 border border-slate-100 px-4 py-2.5 rounded-xl text-2xs font-black uppercase tracking-widest hover:bg-slate-100 active:scale-95 transition-all flex items-center gap-1 group"
 >
