...
export const EditInvestment: React.FC = () => {
 ...
 <div>
 <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">Asset Name</label>
 <input
 type="text"
 value={formData.assetName}
 onChange={(e) => setFormData({ ...formData, assetName: e.target.value })}
 className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200/80 rounded-2xl text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all placeholder:text-slate-400"
 ...
 <div className="rounded-2xl border border-amber-200/80 bg-amber-50/50 p-5 space-y-4">
 ...
 <input type="number" step="0.01" value={metadata.weightGrams || ''} onChange={e => setMetadata(prev => ({ ...prev, weightGrams: parseFloat(e.target.value) || 0 }))} className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-purple-500/20" placeholder="0.00" title="Weight in grams" data-testid="investments-edit-weight-input" />
 </div>
 <div>
 <label className="block text-xs font-semibold text-slate-600 mb-1">Purity</label>
 <input type="text" value={metadata.purity || ''} onChange={e => setMetadata(prev => ({ ...prev, purity: e.target.value }))} className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-purple-500/20" placeholder="e.g. 22K (916)" title="Purity" data-testid="investments-edit-purity-input" />
 </div>
 <div>
 <label className="block text-xs font-semibold text-slate-600 mb-1">Form</label>
 <select value={metadata.form || ''} onChange={e => setMetadata(prev => ({ ...prev, form: e.target.value }))} className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-purple-500/20" title="Form" data-testid="investments-edit-form-select">
 ...
 <div>
 <label className="block text-xs font-semibold text-slate-600 mb-1">BIS HUID</label>
 <input type="text" value={metadata.hallmarkNumber || ''} onChange={e => setMetadata(prev => ({ ...prev, hallmarkNumber: e.target.value.toUpperCase().slice(0, 6) }))} className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-sm font-semibold text-slate-900 tracking-widest focus:outline-none focus:ring-2 focus:ring-purple-500/20" placeholder="6-digit" maxLength={6} title="BIS HUID" data-testid="investments-edit-huid-input" />
 </div>
 <div>
 <label className="block text-xs font-semibold text-slate-600 mb-1">Jeweler</label>
 <input type="text" value={metadata.jewelerName || ''} onChange={e => setMetadata(prev => ({ ...prev, jewelerName: e.target.value }))} className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-purple-500/20" placeholder="Shop name" title="Jeweler" data-testid="investments-edit-jeweler-input" />
 </div>
 <div>
 <label className="block text-xs font-semibold text-slate-600 mb-1">Storage / Locker</label>
 <input type="text" value={metadata.lockerName || ''} onChange={e => setMetadata(prev => ({ ...prev, lockerName: e.target.value }))} className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-purple-500/20" placeholder="e.g. Home Safe" title="Storage" data-testid="investments-edit-locker-input" />
 </div>
 </div>
 <div>
 ...
 <button key={tag} type="button" onClick={() => setMetadata(prev => ({ ...prev, ownershipTag: tag }))} className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all ${metadata.ownershipTag === tag ? 'bg-amber-600 text-white shadow-xs' : 'bg-white border border-slate-200 text-slate-700 hover:bg-slate-50'}`} data-testid={`investments-edit-ownership-${tag}-button`}>
 ...
 <div className="rounded-2xl border border-indigo-200/80 bg-indigo-50/50 p-5 space-y-4">
 ...
 <select value={metadata.propertyType || ''} onChange={e => setMetadata(prev => ({ ...prev, propertyType: e.target.value }))} className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-purple-500/20" title="Property Type" data-testid="investments-edit-property-type">
 ...
 <input type="text" value={metadata.location || ''} onChange={e => setMetadata(prev => ({ ...prev, location: e.target.value }))} className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-purple-500/20" placeholder="City, Area" title="Location" data-testid="investments-edit-property-location" />
 </div>
 <div>
 <label className="block text-xs font-semibold text-slate-600 mb-1">Area (sq.ft)</label>
 <input type="number" value={metadata.areaSqft || ''} onChange={e => setMetadata(prev => ({ ...prev, areaSqft: parseFloat(e.target.value) || 0 }))} className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-purple-500/20" title="Area" data-testid="investments-edit-property-area" />
 </div>
 <div>
 <label className="block text-xs font-semibold text-slate-600 mb-1">Rental Yield %</label>
 <input type="number" step="0.1" value={metadata.rentalYield || ''} onChange={e => setMetadata(prev => ({ ...prev, rentalYield: parseFloat(e.target.value) || 0 }))} className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-purple-500/20" title="Rental Yield" data-testid="investments-edit-property-yield" />
 </div>
 </div>
 </div>
 )}
 ...
 <div>
 <label className="block text-xs font-semibold text-slate-600 mb-1">Ownership %</label>
 <input type="number" min={0} max={100} value={metadata.ownershipPercent || ''} onChange={e => setMetadata(prev => ({ ...prev, ownershipPercent: parseFloat(e.target.value) || 0 }))} className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-purple-500/20" title="Ownership %" data-testid="investments-edit-business-percent" />
 </div>
 <div>
 <label className="block text-xs font-semibold text-slate-600 mb-1">Sector</label>
 <input type="text" value={metadata.sector || ''} onChange={e => setMetadata(prev => ({ ...prev, sector: e.target.value }))} className="w-full px-3 py-2 bg-white border border-slate-200 rounded-xl text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-purple-500/20" placeholder="e.g. Retail" title="Sector" data-testid="investments-edit-business-sector" />
 </div>
 </div>
 </div>
 )}
 ...
 <div>
 <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">Buy Price</label>
 ...
 title="Buy Price"
 />
 <p className="mt-1 text-xs font-medium text-slate-400">Entered in {assetCurrencyCode}</p>
 </div>
 </div>
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
 <div>
 <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">Payment Account</label>
 <select
 ...
 <div>
 <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">Buy-side Fees</label>
 <input
 type="number"
 step="0.01"
 min="0"
 ...
 />
 <p className="mt-1 text-xs font-medium text-slate-400">Entered in {currency}</p>
 </div>
 </div>
 ) : (
 <div className="rounded-2xl border border-amber-200/80 bg-amber-50/60 px-5 py-4">
 <p className="text-sm font-bold text-amber-900">Legacy holding</p>
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
 <div>
 <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">Current Price</label>
 <input
 type="number"
 step="0.01"
 ...
 <div>
 <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">Purchase Date</label>
 <input
 type="date"
 ...
 <div className="bg-gradient-to-br from-slate-900 via-slate-900 to-indigo-950 text-white rounded-[24px] p-6 border border-slate-800 shadow-md space-y-3">
 <div className="flex justify-between items-center text-sm">
 <span className="text-slate-400 font-medium">Total Investment:</span>
 <span className="font-bold text-white text-base">{formatNativeMoney(formData.quantity * formData.buyPrice, assetCurrencyCode)}</span>
 </div>
 {hasTrackedPurchaseCashflow && formData.purchaseFees > 0 && (
 <div className="flex justify-between items-center text-sm">
 <span className="text-slate-400 font-medium">Buy-side Fees:</span>
 <span className="font-bold text-white">{formatNativeMoney(formData.purchaseFees, currency)}</span>
 </div>
 )}
 {hasTrackedPurchaseCashflow && !!formData.fundingAccountId && (
 <div className="flex justify-between items-center text-sm">
 <span className="text-slate-400 font-medium">Payment Account:</span>
 <span className="font-bold text-white">{activeAccounts.find((account) => account.id === formData.fundingAccountId)?.name || 'Selected account'}</span>
 </div>
 )}
 <div className="flex justify-between items-center text-sm border-t border-slate-800/80 pt-2">
 <span className="text-slate-400 font-medium">Current Value:</span>
 <span className="font-bold text-white text-base">{formatNativeMoney(formData.quantity * formData.currentPrice, assetCurrencyCode)}</span>
 </div>
 <div className="flex justify-between items-center text-sm">
 <span className="text-slate-400 font-medium">Profit / Loss:</span>
 <span className={`font-bold text-base ${(formData.quantity * formData.currentPrice) - (formData.quantity * formData.buyPrice) >= 0 ? 'text-emerald-400' : 'text-rose-400'}`}>
 {((formData.quantity * formData.currentPrice) - (formData.quantity * formData.buyPrice)) >= 0 ? '+' : '-'}
 ...
 className="flex-1 h-12 border border-slate-200/80 rounded-full hover:bg-slate-50 transition-all font-bold text-slate-700 active:scale-95 cursor-pointer"
 aria-label="Cancel"
 title="Cancel"
 ...
 <button
 type="submit"
 className="flex-1 h-12 bg-[#18181B] hover:bg-black text-white rounded-full transition-all font-bold active:scale-95 shadow-md cursor-pointer"
