...
export const getCategoryCartoonIcon = (categoryName: string, size: number = 32): React.ReactNode => {
  ...
  const iconMap: Record<string, React.ReactNode> = {
    ...
    'coffee & snacks': <FoodIcon size={size} />,
    'fuel & gas': <TransportationIcon size={size} />,
    'pharmacy & medicine': <HealthIcon size={size} />,
    'books & learning': <EducationIcon size={size} />,
    'laundry & cleaning': <HousingIcon size={size} />,
    'insurance & legal': <ChecklistIcon size={size} />,
    'beauty & grooming': <PersonalCareIcon size={size} />,
    
    // Income
    'salary': <SalaryIcon size={size} />,
    'freelance & side gigs': <FreelanceIcon size={size} />,
    'freelance': <FreelanceIcon size={size} />,
    'investment returns': <InvestmentIcon size={size} />,
    'business': <BusinessIcon size={size} />,
    'business revenue': <BusinessIcon size={size} />,
    'rental income': <HousingIcon size={size} />,
    'rental': <HousingIcon size={size} />,
    'dividends & interest': <InvestmentIcon size={size} />,
    'dividends': <InvestmentIcon size={size} />,
    'bonus & incentives': <SalaryIcon size={size} />,
    'bonus': <SalaryIcon size={size} />,
    'gift & refund': <GiftsIcon size={size} />,
    'gift & donations': <GiftsIcon size={size} />,
    'refund & reimbursement': <TransferIcon size={size} />,
    'refund': <TransferIcon size={size} />,
    'cashback & rewards': <GiftsIcon size={size} />,
    'cashback': <GiftsIcon size={size} />,
    'consulting & advisory': <AdvisorIcon size={size} />,
    'consulting': <AdvisorIcon size={size} />,
    'crypto & web3': <InvestmentIcon size={size} />,
    'grants & scholarships': <EducationIcon size={size} />,
    'pension & retirement': <SalaryIcon size={size} />,
    'royalties & ip': <ReportsIcon size={size} />,
    'asset & item sale': <FinanceIcon size={size} />,
    'overtime & tips': <SalaryIcon size={size} />,
    'alimony & support': <FamilyIcon size={size} />,
    'insurance & settlement': <ChecklistIcon size={size} />,
...
export const getCategoryColor = (categoryName: string): string => {
 ...
 'coffee & snacks': '#D97706',
 'fuel & gas': '#EA580C',
 'pharmacy & medicine': '#0284C7',
 'books & learning': '#2563EB',
 'laundry & cleaning': '#0D9488',
 'insurance & legal': '#7C3AED',
 'beauty & grooming': '#DB2777',
 'salary': '#10B981',
 'freelance & side gigs': '#4834D4',
 'freelance': '#4834D4',
 'business': '#686DE0',
 'rental income': '#06B6D4',
 'dividends & interest': '#F97316',
 'bonus & incentives': '#10B981',
 'refund & reimbursement': '#14B8A6',
 'cashback & rewards': '#84CC16',
 'consulting & advisory': '#6366F1',
 'crypto & web3': '#F59E0B',
 'grants & scholarships': '#3B82F6',
 'pension & retirement': '#64748B',
 'royalties & ip': '#A855F7',
 'asset & item sale': '#0EA5E9',
 'overtime & tips': '#EAB308',
 'alimony & support': '#F43F5E',
 'insurance & settlement': '#2DD4BF',
 };
