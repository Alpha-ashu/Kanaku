...
const EXPENSE_CATEGORY_SEEDS: ExpenseCategorySeed[] = [
  ...
  },
  {
    ...
    icon: '',
    color: '#D97706',
    aliases: ['coffee', 'tea', 'cafe', 'snacks', 'bakery'],
    subcategories: ['Coffee', 'Tea', 'Snacks', 'Chai', 'Bakery', 'Smoothies'],
  },
  {
    name: 'Fuel & Gas',
    icon: '',
    color: '#EA580C',
    aliases: ['fuel', 'petrol', 'diesel', 'gas station'],
  ...
  },
  {
    ...
    icon: '',
    color: '#0284C7',
    aliases: ['pharmacy', 'medicine', 'drugs', 'chemist'],
    subcategories: ['Prescription Medicines', 'First Aid', 'Vitamins & Supplements', 'Health Supplies'],
  },
  {
    name: 'Books & Learning',
    icon: '',
    color: '#2563EB',
    aliases: ['books', 'reading', 'learning', 'courses'],
    subcategories: ['Books', 'Audiobooks', 'Online Courses', 'E-Books', 'Certificates'],
  },
  {
    name: 'Laundry & Cleaning',
    icon: '',
    color: '#0D9488',
    aliases: ['laundry', 'dry cleaning', 'cleaning'],
    subcategories: ['Dry Cleaning', 'Washing', 'Detergents & Cleaners', 'House Cleaning'],
  },
  {
    name: 'Insurance & Legal',
    icon: '',
    color: '#7C3AED',
    aliases: ['insurance', 'policy', 'legal'],
    subcategories: ['Life Insurance', 'General Insurance', 'Legal Services', 'Documentation'],
  },
  {
    name: 'Beauty & Grooming',
    icon: '',
    color: '#DB2777',
    aliases: ['beauty', 'cosmetics', 'grooming', 'salon'],
    subcategories: ['Hair & Salon', 'Skincare', 'Makeup', 'Spa & Massage'],
  },
];
...
export const INCOME_CATEGORIES = {
  ...
  rental: {
    ...
    icon: '',
    color: '#06B6D4',
    subcategories: ['Apartment Rent', 'Commercial Rent', 'Parking Rent', 'Subletting', 'Storage Rental'],
  },
  dividends: {
    name: 'Dividends & Interest',
    icon: '',
    color: '#F97316',
    subcategories: ['Stock Dividends', 'Bank Interest', 'FD Interest', 'Bond Coupon', 'Peer to Peer Lending'],
  },
  bonus: {
    name: 'Bonus & Incentives',
    icon: '',
    color: '#10B981',
    subcategories: ['Annual Bonus', 'Performance Bonus', 'Signing Bonus', 'Referral Incentive', 'Holiday Bonus'],
  },
  gift: {
    name: 'Gift & Refund',
    icon: '',
  ...
  refund: {
    ...
    icon: '',
    color: '#14B8A6',
    subcategories: ['Expense Reimbursement', 'Travel Claim', 'Merchant Refund', 'Tax Refund', 'Security Deposit Return'],
  },
  cashback: {
    name: 'Cashback & Rewards',
    icon: '',
    color: '#84CC16',
    subcategories: ['Credit Card Cashback', 'App Rewards', 'Coupons & Loyalty', 'Promo Cashback'],
  },
  consulting: {
    name: 'Consulting & Advisory',
    icon: '',
    color: '#6366F1',
    subcategories: ['Advisory Retainer', 'Technical Consulting', 'Legal Advisory', 'Board Meeting Fee'],
  },
  crypto: {
    name: 'Crypto & Web3',
    icon: '',
    color: '#F59E0B',
    subcategories: ['Staking Rewards', 'Airdrops', 'Mining Income', 'Crypto Trading', 'Yield Farming'],
  },
  grants: {
    name: 'Grants & Scholarships',
    icon: '',
    color: '#3B82F6',
    subcategories: ['Research Grant', 'University Scholarship', 'Government Subsidy', 'Fellowship'],
  },
  pension: {
    name: 'Pension & Retirement',
    icon: '',
    color: '#64748B',
    subcategories: ['Monthly Pension', 'EPF / PF Withdrawal', 'Annuity Payout', 'Gratuity'],
  },
  royalty: {
    name: 'Royalties & IP',
    icon: '',
    color: '#A855F7',
    subcategories: ['Book Royalties', 'Music Licensing', 'Patent Royalty', 'Content Licensing'],
  },
  sales: {
    name: 'Asset & Item Sale',
    icon: '',
    color: '#0EA5E9',
    subcategories: ['Car Sale', 'Gadget Sale', 'Furniture Sale', 'Jewelry Sale', 'Collectibles'],
  },
  overtime: {
    name: 'Overtime & Tips',
    icon: '',
    color: '#EAB308',
    subcategories: ['Overtime Hours', 'Tips Received', 'Shift Allowance', 'Weekend Differential'],
  },
  alimony: {
    name: 'Alimony & Support',
    icon: '',
    color: '#F43F5E',
    subcategories: ['Child Support', 'Alimony Payment', 'Family Support'],
  },
  settlement: {
    name: 'Insurance & Settlement',
    icon: '',
    color: '#2DD4BF',
    subcategories: ['Insurance Claim', 'Legal Settlement', 'Damage Compensation'],
  },
  other: {
    name: 'Other Income',
    icon: '',
    color: '#64748B',
    subcategories: ['Award', 'Inheritance', 'Settlement', 'Residual Income', 'Stipend', 'Scholarship', 'Pension'],
  },
};
