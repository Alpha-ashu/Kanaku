...
- Name: test-refresh-redirect.spec.ts >> P1 Bug: Page Refresh State Persistence >> Scenario 2: Navigate to Accounts → Refresh → should stay on Accounts
- Location: tests\e2e\test-refresh-redirect.spec.ts:56:3
