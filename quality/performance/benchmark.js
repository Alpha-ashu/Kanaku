...
async function runBenchmark() {
  ...
  // Other endpoints
  results.push(await benchmarkEndpoint('dashboard', '/dashboard', 10));
  ...
  results.push(await benchmarkEndpoint('reports', '/reports', 10));
  results.push(await benchmarkEndpoint('todos', '/todos/lists', 10));
