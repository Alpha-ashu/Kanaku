...
- Name: 09-pom-regression.spec.ts >> Kanaku/Finora - Comprehensive Playwright POM & Regression Test Suite >> 10. Logout/Login Session Retention & State Check
- Location: quality\e2e\09-pom-regression.spec.ts:389:3

# Error details

```
Error: Login challenge failed for arjun.test@kanaku.app: {"success":false,"error":"Our servers are temporarily unavailable. Please try again in a moment.","code":"DATABASE_UNAVAILABLE","requestId":"ed1d8a7c-d993-4e4a-9e1f-30ab48919608"}
```
