...
1. **What is Kanaku** — [`../../README.md`](../../README.md)
2. **Architecture (the big picture)** — [`../../ARCHITECTURE_RESTRUCTURE.md`](../../ARCHITECTURE_RESTRUCTURE.md)
3. **Feature map (find any feature end-to-end)** — [`../architecture/FEATURE_MAP.md`](../architecture/FEATURE_MAP.md)
4. **Developer context & rules** — [`../../KANAKU_DEVELOPER_CONTEXT.md`](../../KANAKU_DEVELOPER_CONTEXT.md)
5. **Contributing** — [`../CONTRIBUTING.md`](../CONTRIBUTING.md)
6. **Guidelines (AI + design system)** — [`../guidelines/Guidelines.md`](../guidelines/Guidelines.md)
7. **Quick reference** — [`../DEVELOPER_QUICK_REFERENCE.md`](../DEVELOPER_QUICK_REFERENCE.md)
...
| See an API contract | `api-docs/<feature>/` |
