...
## What You Can Do as an Advisor (Your Features)

### Profile Management
- Create and maintain a public advisor profile visible to Clients
- Set your specializations: budgeting, investing, tax planning, debt management, retirement, etc.
- Upload professional credentials and certifications
- Set your hourly rate, session packages, and currency
- Write a professional bio and service description

### Availability Management
- Set your available time slots on a weekly calendar
- Block out holidays or unavailable periods
- Set session duration options (30 min, 60 min, 90 min)
- Enable/disable instant booking vs. request-only mode

### Client Management
- View incoming booking requests and accept or decline
- Access client-shared financial data (only what clients authorize)
- Communicate with clients via in-app messaging
- Leave post-session notes and recommendations in the client's account
...
### Analytics
- View your session completion rate, client ratings, and review scores
- Track total clients served, sessions completed, and revenue earned

---

## Your Responsibilities as an Advisor (Dos)

| Do | Why |
|----|-----|
| Provide accurate credentials during your application | False credentials result in permanent ban and potential legal action |
| Clearly state your areas of expertise in your profile | Clients need to choose the right advisor for their needs |
| Respond to booking requests within 24 hours | Clients expect timely responses |
| Attend all confirmed sessions on time | No-shows damage client trust and result in platform penalties |
| Maintain client confidentiality strictly | You are handling sensitive financial data |
| Provide only guidance within your professional competence | Offering advice outside your expertise is harmful and a terms violation |
| Disclose any conflict of interest to the client | Required by professional ethics |
...
## Things You Must Not Do as an Advisor (Don'ts)
...
| Accept personal gifts or financial incentives from clients outside the platform | Conflict of interest violation |

---

## What You Can and Cannot Access in Client Data

### You CAN:
- View data that the client has explicitly authorized for sharing
- Read transaction history, budgets, and goals (only if the client enabled it)
- Leave notes and session summaries in the client's account
- Message clients through the in-app chat
...
By joining as an Advisor, you confirm that:
- You are a real individual (not a company account — advisors are individual professionals)
- All credentials you listed are genuine and current
...
## Earnings, Fees & Payouts

| Item | Details |
|------|---------|
| Platform fee | As stated in your onboarding agreement (typically 15–25%) |
...
- Your no-show rate exceeds 5% of confirmed sessions

You will receive a warning before any suspension. You may appeal suspension decisions via **Settings > Help > Appeal**.

---

## Advisor Application & Approval

Your application included:
1. Full legal name and contact details
2. Professional qualifications and certifications (uploaded documents)
...
- You are found to be engaging in financial fraud or misconduct

On termination, you retain access to earnings records for tax purposes for 6 months, after which your account data is deleted.
