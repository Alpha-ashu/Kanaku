...
- You are responsible for maintaining the security of your account credentials (password, PIN, device).
- One person = one account. Creating multiple accounts is not allowed.
...
## 4. Platform Rules (All Roles)

### What is always allowed:
- Using the platform for legitimate personal finance management
- Requesting support via official channels
- Reporting bugs, security issues, or inappropriate content

### What is never allowed:
- Attempting to hack, reverse-engineer, or exploit the platform
- Sharing your login credentials with others
- Uploading illegal, fraudulent, or misleading financial data
...
- For full details, see our **Privacy Policy** (separate document).
...
- Voice recordings processed for logging are not stored after processing (raw audio is discarded).
...
On termination, your data will be retained for 30 days then permanently deleted, unless we are legally required to retain it longer.
...
We may update these terms. We will notify you by email and in-app notification at least **14 days** before changes take effect. Continued use after the effective date means you accept the updated terms.
